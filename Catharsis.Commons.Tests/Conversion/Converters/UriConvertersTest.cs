...
{
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.Bytes(IConversion{Uri}, TimeSpan?, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.BytesAsync(IConversion{Uri}, TimeSpan?, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.Text(IConversion{Uri}, Encoding, TimeSpan?, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.XmlDocument(IConversion{Uri}, TimeSpan?, string, ValueTuple{string, object}[]"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.XmlDocumentAsync(IConversion{Uri}, TimeSpan?, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.XDocument(IConversion{Uri}, TimeSpan?, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
  ...
  /// <summary>
  ///   <para>Performs testing of <see cref="UriConverters.XDocumentAsync(IConversion{Uri}, TimeSpan?, CancellationToken, string, ValueTuple{string, object}[])"/> method.</para>
  /// </summary>
  [Fact]
